...
export default function ConnexionPage() {
  ...
  // Flags pour éviter le narrowing de type problématique
    ...
    try {
      ...
      if (isNounou) {
        if (nounouMode === "avec-agence") {
          ...
          // ✅ Connexion sans DB : créer un utilisateur fictif
          const fakeUser = {
            id: `fake-${Date.now()}`,
            user_id: `fake-user-${Date.now()}`,
            nom: "Nounou Test",
            telephone: telephone || "0700000000",
            quartier: "Cocody",
            agence_id: "fake-agence-1",
          ...
          setUser(fakeUser);
          setNounouModeStore("avec-agence");
        ...
        if (nounouMode === "sans-agence") {
          ...
          setUser(fakeUser);
          setNounouModeStore("sans-agence");
      ...
      const fakeUser = {
        id: `fake-${Date.now()}`,
        user_id: `fake-user-${Date.now()}`,
        nom: selectedProfil === "menage" ? "Famille Test" : "Agence Test",
        telephone: telephone,
        quartier: "Cocody",
        ...(selectedProfil === "agence" && { description: "Agence de test" }),
        created_at: new Date().toISOString(),
      };
