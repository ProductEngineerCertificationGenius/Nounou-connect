  ...
  return (
    <div ref={cardRef} className={`demande-card ${isHighlighted ? "highlighted" : ""}`}>
      ...
      <div className="demande-card-body">
        ...
        {/* Nounou souhaitée par la famille (choisie directement dans la
            recherche) ou déjà assignée par l'agence */}
        {demande.nounou_assignee && (
          <div className="demande-nounou-assignee">
            <span className="assignee-label">
              {demande.statut === "Assignée" ? "👩 Nounou assignée" : "👩 Nounou souhaitée par la famille"}
            </span>
              ...
              {demande.nounou_assignee ? (
                <>
                  <button
                    ...
                    onClick={() => onAssigner(demande.id, demande.nounou_assignee!.id)}
                  >
                    <UserCheck size={14} /> Confirmer {demande.nounou_assignee.nom}
                  </button>
                  <button className="btn-contacter" onClick={() => setShowAssignModal(true)} title="Choisir une autre nounou">
                    Changer
                  </button>
                </>
              ) : (
